...
function AccountBody() {
  return (
    <div className="account-body">
      ...
      <p className="account-copy">MI TRENDS keeps checkout simple — no account or password required. Add pieces to your bag and wishlist, and check out with just your delivery details.</p>
      <div className="account-links">
        <Link href="/info/track-order"><Package size={17} /><span>Track an order</span><ArrowRight size={15} /></Link>
        <Link href="/wishlist"><Sparkles size={17} /><span>View your wishlist</span><ArrowRight size={15} /></Link>
...
export default function InfoPage() {
  ...
  const special: Record<string, { header: PageContent; body: React.ReactNode }> = {
    ...
    account: { header: { eyebrow: "Your account", title: "NO PASSWORD\nNEEDED.", intro: "Here's how shopping without an account works at MI TRENDS.", sections: [] }, body: <AccountBody /> },
  };
